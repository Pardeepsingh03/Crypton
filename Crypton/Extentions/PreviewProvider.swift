...
class DeveloperPreview {
    ...
    let stat1 = StatistisModel(title: "Market Cap", value: "$12.5Bn", percentageValue: 25.34)
    let stat2 = StatistisModel(title: "Total Volume", value: "$1.23Tr")
    let stat3 = StatistisModel(title: "Portfolio Value", value: "$50.4k", percentageValue: -12.34)
